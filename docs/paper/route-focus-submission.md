...
휘발유 수요는 가격에 둔감하여[1], 소비자는 이동 자체를 줄이기보다 주유 비용을 낮추는 방향으로 선택을 조정하는 경향을 보인다. 또한 주유소 선택 요인에 관한 연구[2]에서 가격은 재방문 의도에 유의한 음의 영향을 미치는 요인으로 보고되며, 주유소 간 리터당 가격 차이는 소비자의 주유소 선택에 중요하게 작용한다.
